...
# App Configuration
# --------------------------------------------------
st.set_page_config(page_title="Tourism Experience Analytics System", layout="wide")
...
# Show model selection only for prediction tasks
if task != "Attraction Recommendation":
...
# --------------------------------------------------
# Recommendation Dropdown (Moved Outside Button)
# --------------------------------------------------
if task == "Attraction Recommendation":
...
if st.button("Run"):
    ...
    if task in ["Rating Prediction", "Visit Mode Prediction"]:
        ...
        recs = recommend_attractions(attraction_type)
        st.dataframe(recs)


# --------------------------------------------------
# Business Insights (STATIC – Correct Behavior)
# --------------------------------------------------
st.markdown("---")
...
# --------------------------------------------------
# Visit Mode Distribution (STATIC – Correct Behavior)
# --------------------------------------------------
